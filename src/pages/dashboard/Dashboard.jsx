      ...
      <Row className="mb-4">
        <Col xs={6} md={3} className="mb-3">
          <Card style={cardStyle} className="text-center p-3">
            ...
            <p
              style={{ color: "#aaaaaa", marginBottom: 0, fontSize: "0.85rem" }}
            >
              Prenotazioni attive
            </p>
          </Card>
            ...
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h5 style={{ color: "#ffffff", marginBottom: 0 }}>
                  📅 Prossime{" "}
                  <span style={{ color: "#ff6b00" }}>prenotazioni</span>
                </h5>
                <Button
                  size="sm"
              ...
              {loadingBookings ? (
                ...
                <div className="text-center py-3">
                  <p style={{ color: "#aaaaaa" }} className="mb-2">
                    ...
                    <div className="d-flex justify-content-between mb-1">
                      ...
                      <span
                        style={{
                          fontSize: "0.85rem",
                          color:
                            zone.occupancyStatus === "HIGH"
                              ? "#dc3545"
                              : zone.occupancyStatus === "MEDIUM"
                                ? "#ffc107"
                                : zone.occupancyStatus === "LOW"
                                  ? "#28a745"
                                  : "#aaaaaa",
                        }}
                      >
